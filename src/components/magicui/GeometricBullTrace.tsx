...
export const GeometricBullTrace: React.FC<GeometricBullTraceProps> = ({
  className = "w-full h-full",
  strokeWidth = 2.4,
  triggerSound = false,
  repeatInterval = 8500,
  glowId = "bullLaserGlow",
  gradId = "bullLineGrad",
}) => {
  ...
  }, [triggerSound, repeatInterval]);

  return (
    <div className={`overflow-visible relative ${className}`}>
      <svg
        key={`bull-trace-${animationCycle}`}
      ...
      >
        <defs>
          <filter id={glowId} x="-30%" y="-30%" width="160%" height="160%">
            ...
            <feGaussianBlur in="SourceGraphic" stdDeviation="5" result="s2" />
            <feMerge>
              <feMergeNode in="s2" />
              <feMergeNode in="s1" />
        ...
        {/* SINGLE CONTINUOUS LASER DRAWING: Completely turns off after 1.5s hold */}
        <motion.path
          ...
          animate={{
            pathLength: [0, 1, 1, 1],
            opacity: [0, 1, 1, 0], // Invisible -> Drawing -> Holds 1.5s -> Completely turned off
          }}
          transition={{
            delay: 0.6,
            duration: 3.1,
